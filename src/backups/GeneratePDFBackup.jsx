...
//     // 1st Page
//     await doc.html(document.querySelector("#page-original"), {
//       autoPaging: "text",
//       margin: [40, 60, 40, 60],
//       x: 0,
//       y: 0,
...
//         // 2nd Page
//         await doc.html(document.querySelector("#page-duplicate"), {
//           autoPaging: "text",
//           margin: [40, 60, 40, 60],
//           x: 0,
//           y: 0,
...
//             await doc.html(document.querySelector("#page-triplicate"), {
//               autoPaging: "text",
//               margin: [40, 60, 40, 60],
//               x: 0,
//               y: 0,
